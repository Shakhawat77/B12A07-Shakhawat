...
const Footer = () => {
  return (
    <footer className="bg-black text-white py-10 px-6 ">
      <div className="max-w-7xl mx-auto grid grid-cols-1  lg:grid-cols-5 gap-8 py-5">
        <div>
      ...
      <div className="pt-10 border-t border-gray-700 mt-18  text-center text-gray-400 text-sm ">
